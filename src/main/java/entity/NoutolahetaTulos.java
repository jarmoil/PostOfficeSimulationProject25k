 ...
 */
@Entity
@Table(name = "noutolaheta")
public class NoutolahetaTulos implements IServicePointTulos {

    /**
     * Unique identifier for the pickup and dispatch result.
     */
    @Id
     ...
     */
    public NoutolahetaTulos() {}

    /**
     * Constructs a new NoutolahetaTulos with all fields.
     *
     ...
     */
    public NoutolahetaTulos(int jonossa, int palveltu, double keskimjonoaika, double keskimpalveluaika, double kokonaisaika,
    ...
    /**
     * Gets the unique identifier of the pickup and dispatch result.
     *
    ...
    /**
     * Sets the unique identifier of the pickup and dispatch result.
     *
