...
/**
 * Entity class representing parcel locker (Pakettiautomaatti) results in the simulation.
 * Maps to the "pakettiautomaatti" table in the database using JPA/Hibernate annotations.
 * Implements IServicePointTulos interface for standardized service point result handling.
 */
@Entity
@Table(name = "pakettiautomaatti")
public class PakettiautomaattiTulos implements IServicePointTulos {

    /**
     * Unique identifier for the parcel locker result.
     */
    @Id
    ...
    /**
     * Constructs a new PakettiautomaattiTulos with all fields.
     *
    ...
    /**
     * Gets the unique identifier of the parcel locker result.
     *
    ...
    /**
     * Sets the unique identifier of the parcel locker result.
     *
